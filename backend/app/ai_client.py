...
2. 再组织反馈内容。
   - 作业完成情况是主线。
   - 根据输入自然包含晚辅纪律、做得好的点、存在的问题和建议，不强制每条写满所有维度。
   - 表扬点和问题点必须有输入依据；没有依据就自然省略或轻轻带过。
3. 最后处理建议。
   - 老师输入里有明确建议时，以老师建议为主，只做润色。
   - 老师没写建议时，可以基于本次事实补一句普适提醒，例如纪律、效率、书写、主动思考或继续保持。
        ...
        "messages": [
            {
                ...
                "content": (
                    ...
                    "反馈要短、准、真实，优先围绕作业完成情况、可依据的表扬点、可依据的问题和具体建议组织。"
